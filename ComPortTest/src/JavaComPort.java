...
//        private JScrollPane scrollPaneInput = new JScrollPane(input);
//        private JLabel label1 = new JLabel("nbCom");
//        private JLabel label2 = new JLabel("Power");
    ...
    // JButton
            ...
            // зарегистрировать экземпляр класса обработчика события button
...
//                                System.out.println("arrReadComByte[i + 2] " + arrReadComByte[i + 2]);
//                                System.out.println("arrReadComByte[i + 3] " + (arrReadComByte[i + 3] & 0x00ff));
...
// Метод Main
    ...
    public static void main(String[] args) {
        ...
        PortReader pRead = javaComPort.new PortReader();
        Form form = javaComPort.new Form();
        pRead.serialEvent(event);
